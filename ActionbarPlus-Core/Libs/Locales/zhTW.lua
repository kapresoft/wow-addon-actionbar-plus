...
L['Layout'] = '版面配置'
L['Layout Type'] = '版面配置類型'
L['Layout Type Tooltip'] = '網格為內建功能。其他版面配置（如弧形）是可另外安裝的選用附加元件，可提供更多形狀。'
L['Grid'] = '網格'
L['Arc'] = '弧形'
L['Arc Direction'] = '弧形方向'
L['Arc Span'] = '弧形跨度'
L['Up'] = '頂部'
L['Down'] = '底部'
L['Horizontal Spacing'] = '水平間距'
L['Vertical Spacing'] = '垂直間距'
L['Extra Button Spacing'] = '額外按鈕間距'
L['Global']                = '全域'
...
L['Last-Update'] = '最後更新'
L['Locale'] = '語言'
L['Interface-Version'] = '介面版本'
L['Available commands:'] = '可用指令:'
L['displays the addon info'] = '顯示附加元件資訊'
L['lists available profiles'] = '列出可用的設定檔'
L['Available profiles:'] = '可用設定檔:'
L['No profiles match:'] = '沒有符合的設定檔:'
L['switches to the named profile'] = '切換到指定的設定檔'
L['Usage'] = '用法'
L['Switches to the named profile. Use /abp profiles to see available profiles.'] = '切換到指定的設定檔。使用 /abp profiles 查看可用的設定檔。'
L['Cannot switch profiles while in combat.'] = '戰鬥中無法切換設定檔。'
L['No such profile:'] = '沒有此設定檔:'
L['Switched to profile:'] = '已切換到設定檔:'
L['Already on profile:'] = '已經在使用設定檔:'
L['current'] = '目前'
