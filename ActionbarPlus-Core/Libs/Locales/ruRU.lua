...
L['Layout'] = 'Раскладка'
L['Layout Type'] = 'Тип раскладки'
L['Layout Type Tooltip'] = 'Сетка встроена по умолчанию. Дополнительные раскладки (например, Дуга) — это отдельные необязательные дополнения, которые можно установить для других форм.'
L['Grid'] = 'Сетка'
L['Arc'] = 'Дуга'
L['Arc Direction'] = 'Направление дуги'
L['Arc Span'] = 'Раствор дуги'
L['Up'] = 'Сверху'
L['Down'] = 'Снизу'
L['Horizontal Spacing'] = 'Горизонтальный интервал'
L['Vertical Spacing'] = 'Вертикальный интервал'
L['Extra Button Spacing'] = 'Интервал доп. кнопок'
L['Global']                = 'Глобально'
...
L['displays the addon info'] = 'показывает информацию о дополнении'
L['lists available profiles'] = 'показывает доступные профили'
L['Available profiles:'] = 'Доступные профили:'
L['No profiles match:'] = 'Нет профилей, соответствующих:'
L['switches to the named profile'] = 'переключается на указанный профиль'
