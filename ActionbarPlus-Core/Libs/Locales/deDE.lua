...
L['Layout Type Tooltip'] = 'Raster ist integriert. Zusätzliche Layouts (wie Bogen) sind separate, optionale Add-ons, die du für weitere Formen installieren kannst.'
L['Grid'] = 'Raster'
L['Arc'] = 'Bogen'
L['Arc Direction'] = 'Bogenrichtung'
L['Arc Span'] = 'Bogenspanne'
L['Up'] = 'Oben'
L['Down'] = 'Unten'
L['Horizontal Spacing'] = 'Horizontaler Abstand'
L['Vertical Spacing'] = 'Vertikaler Abstand'
L['Extra Button Spacing'] = 'Abstand zusätzlicher Schaltflächen'
L['Global']                = 'Global'
...
L['displays the addon info'] = 'zeigt die Addon-Info an'
L['lists available profiles'] = 'listet verfügbare Profile auf'
L['Available profiles:'] = 'Verfügbare Profile:'
L['No profiles match:'] = 'Keine Profile passen zu:'
L['switches to the named profile'] = 'wechselt zum genannten Profil'
L['Usage'] = 'Verwendung'
L['Switches to the named profile. Use /abp profiles to see available profiles.'] = 'Wechselt zum genannten Profil. Verwende /abp profiles, um verfügbare Profile anzuzeigen.'
L['Cannot switch profiles while in combat.'] = 'Profile können im Kampf nicht gewechselt werden.'
L['No such profile:'] = 'Kein solches Profil:'
L['Switched to profile:'] = 'Zu Profil gewechselt:'
L['Already on profile:'] = 'Bereits im Profil:'
L['current'] = 'aktuell'
