...
L['Layout Type Tooltip'] = '그리드는 기본으로 내장되어 있습니다. 아크와 같은 추가 레이아웃은 더 많은 모양을 위해 설치할 수 있는 별도의 선택적 애드온입니다.'
L['Grid'] = '그리드'
L['Arc'] = '아크'
L['Arc Direction'] = '아크 방향'
L['Arc Span'] = '아크 범위'
L['Up'] = '위'
L['Down'] = '아래'
L['Horizontal Spacing'] = '가로 간격'
L['Vertical Spacing'] = '세로 간격'
L['Extra Button Spacing'] = '추가 버튼 간격'
L['Global']                = '전역'
...
L['Bugs'] = '버그'
L['Repo'] = '저장소'
L['Last-Update'] = '마지막 업데이트'
L['Locale'] = '언어'
L['Interface-Version'] = '인터페이스 버전'
L['Available commands:'] = '사용 가능한 명령어:'
L['displays the addon info'] = '애드온 정보를 표시합니다'
L['lists available profiles'] = '사용 가능한 프로필을 표시합니다'
L['Available profiles:'] = '사용 가능한 프로필:'
L['No profiles match:'] = '일치하는 프로필이 없습니다:'
L['switches to the named profile'] = '지정한 프로필로 전환합니다'
L['Usage'] = '사용법'
L['Switches to the named profile. Use /abp profiles to see available profiles.'] = '지정한 프로필로 전환합니다. 사용 가능한 프로필을 보려면 /abp profiles를 사용하세요.'
L['Cannot switch profiles while in combat.'] = '전투 중에는 프로필을 전환할 수 없습니다.'
L['No such profile:'] = '해당 프로필이 없습니다:'
L['Switched to profile:'] = '프로필로 전환했습니다:'
L['Already on profile:'] = '이미 해당 프로필입니다:'
L['current'] = '현재'
