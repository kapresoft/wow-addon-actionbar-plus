...
L['Layout Type Tooltip'] = 'La grille est intégrée. Les dispositions supplémentaires (comme Arc) sont des extensions distinctes et facultatives que vous pouvez installer pour davantage de formes.'
L['Grid'] = 'Grille'
L['Arc'] = 'Arc'
L['Arc Direction'] = 'Direction de l\'arc'
L['Arc Span'] = 'Étendue de l\'arc'
L['Up'] = 'Haut'
L['Down'] = 'Bas'
L['Horizontal Spacing'] = 'Espacement horizontal'
L['Vertical Spacing'] = 'Espacement vertical'
L['Extra Button Spacing'] = 'Espacement des boutons supplémentaires'
L['Global']                = 'Global'
...
L['Theme']                 = 'Thème'
L['Version']               = 'Version'
L['Addon Info'] = 'Infos sur l\'addon'
L['Author'] = 'Auteur'
...
L['Locale'] = 'Langue'
L['Interface-Version'] = 'Version d\'interface'
L['Available commands:'] = 'Commandes disponibles :'
L['displays the addon info'] = 'affiche les infos de l\'addon'
L['lists available profiles'] = 'liste les profils disponibles'
L['Available profiles:'] = 'Profils disponibles :'
L['No profiles match:'] = 'Aucun profil ne correspond à :'
L['switches to the named profile'] = 'bascule vers le profil indiqué'
L['Usage'] = 'Utilisation'
L['Switches to the named profile. Use /abp profiles to see available profiles.'] = 'Bascule vers le profil indiqué. Utilisez /abp profiles pour voir les profils disponibles.'
L['Cannot switch profiles while in combat.'] = 'Impossible de changer de profil en combat.'
L['No such profile:'] = 'Aucun profil de ce nom :'
L['Switched to profile:'] = 'Basculé vers le profil :'
L['Already on profile:'] = 'Déjà sur le profil :'
L['current'] = 'actuel'
