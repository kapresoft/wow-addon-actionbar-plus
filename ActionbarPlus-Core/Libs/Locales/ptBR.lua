...
L['Layout Type Tooltip'] = 'A grade já vem integrada. Layouts adicionais (como Arco) são complementos separados e opcionais que você pode instalar para mais formatos.'
L['Grid'] = 'Grade'
L['Arc'] = 'Arco'
L['Arc Direction'] = 'Direção do arco'
L['Arc Span'] = 'Amplitude do arco'
L['Up'] = 'Acima'
L['Down'] = 'Abaixo'
L['Horizontal Spacing'] = 'Espaçamento horizontal'
L['Vertical Spacing'] = 'Espaçamento vertical'
L['Extra Button Spacing'] = 'Espaçamento de botões extras'
L['Global']                = 'Global'
...
L['Bugs'] = 'Erros'
L['Repo'] = 'Repositório'
L['Last-Update'] = 'Última atualização'
L['Locale'] = 'Idioma'
L['Interface-Version'] = 'Versão da interface'
L['Available commands:'] = 'Comandos disponíveis:'
L['displays the addon info'] = 'exibe as informações do addon'
L['lists available profiles'] = 'lista os perfis disponíveis'
L['Available profiles:'] = 'Perfis disponíveis:'
L['No profiles match:'] = 'Nenhum perfil corresponde a:'
L['switches to the named profile'] = 'muda para o perfil indicado'
L['Usage'] = 'Uso'
L['Switches to the named profile. Use /abp profiles to see available profiles.'] = 'Muda para o perfil indicado. Use /abp profiles para ver os perfis disponíveis.'
L['Cannot switch profiles while in combat.'] = 'Não é possível trocar de perfil em combate.'
L['No such profile:'] = 'Perfil inexistente:'
L['Switched to profile:'] = 'Alterado para o perfil:'
L['Already on profile:'] = 'Já está no perfil:'
L['current'] = 'atual'
