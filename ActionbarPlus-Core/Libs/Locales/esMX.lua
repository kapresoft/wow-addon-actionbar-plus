...
L['Layout Type Tooltip'] = 'La cuadrícula viene integrada. Los diseños adicionales (como Arco) son complementos aparte y opcionales que puedes instalar para más formas.'
L['Grid'] = 'Cuadrícula'
L['Arc'] = 'Arco'
L['Arc Direction'] = 'Dirección del arco'
L['Arc Span'] = 'Amplitud del arco'
L['Up'] = 'Arriba'
L['Down'] = 'Abajo'
L['Horizontal Spacing'] = 'Espaciado horizontal'
L['Vertical Spacing'] = 'Espaciado vertical'
L['Extra Button Spacing'] = 'Espaciado de botones adicionales'
L['Global']                = 'Global'
...
L['lists available profiles'] = 'muestra los perfiles disponibles'
L['Available profiles:'] = 'Perfiles disponibles:'
L['No profiles match:'] = 'Ningún perfil coincide con:'
L['switches to the named profile'] = 'cambia al perfil indicado'
L['Usage'] = 'Uso'
L['Switches to the named profile. Use /abp profiles to see available profiles.'] = 'Cambia al perfil indicado. Usa /abp profiles para ver los perfiles disponibles.'
L['Cannot switch profiles while in combat.'] = 'No se puede cambiar de perfil en combate.'
L['No such profile:'] = 'No existe ese perfil:'
L['Switched to profile:'] = 'Se cambió al perfil:'
L['Already on profile:'] = 'Ya estás en el perfil:'
L['current'] = 'actual'
