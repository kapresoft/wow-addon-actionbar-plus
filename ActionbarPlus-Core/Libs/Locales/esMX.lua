...
--- @type AceLocale-3.0
local L = LibStub("AceLocale-3.0"):NewLocale(ns.name, "esMX", false)
...
L['Mouseover Glow']         = 'Brillo al pasar el mouse'
L['Mouseover Glow Tooltip'] = 'Cuando está activado, los botones brillan al pasar el mouse sobre ellos.'
L['Gap']                   = 'Espacio'
...
-- Long texts
L['Drag the bar by hovering over the handle at the selected location.'] = 'Arrastra la barra pasando el mouse sobre el asa en la posición seleccionada.'
...
L['Profiles']                                           = 'Perfiles'
L['Extra Buttons Tooltip'] = 'Una sola fila de botones colocada fuera del borde de la barra. Útil para consumibles, baratijas u objetos situacionales que quieras tener cerca pero separados de tu barra principal.'
...
L['Mouse over a button and %s to set its binding']      = 'Pasa el mouse sobre un botón y %s para asignar su atajo'
L['or press %s to clear it']                            = 'o presiona %s para borrarlo'
