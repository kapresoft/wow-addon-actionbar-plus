...
L['Layout']               = true
L['Layout Type']          = true
L['Layout Type Tooltip']  = 'Grid is built in. Additional layouts (like Arc) are separate, optional add-ons you can install for more shapes.'
L['Grid']                 = true
L['Arc']                  = true
L['Arc Direction']        = true
L['Arc Span']             = true
L['Up']                   = true
L['Down']                 = true
