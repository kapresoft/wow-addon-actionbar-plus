...
L['Layout'] = '布局'
L['Layout Type'] = '布局类型'
L['Layout Type Tooltip'] = '网格是内置的。其他布局（如弧形）是可单独安装的可选插件，可提供更多形状。'
L['Grid'] = '网格'
L['Arc'] = '弧形'
...
L['lists available profiles'] = '列出可用的配置文件'
L['Available profiles:'] = '可用配置文件:'
L['No profiles match:'] = '没有匹配的配置文件:'
L['switches to the named profile'] = '切换到指定的配置文件'
L['Usage'] = '用法'
L['Switches to the named profile. Use /abp profiles to see available profiles.'] = '切换到指定的配置文件。使用 /abp profiles 查看可用的配置文件。'
L['Cannot switch profiles while in combat.'] = '战斗中无法切换配置文件。'
L['No such profile:'] = '没有此配置文件:'
L['Switched to profile:'] = '已切换到配置文件:'
L['Already on profile:'] = '已经在使用配置文件:'
L['current'] = '当前'
