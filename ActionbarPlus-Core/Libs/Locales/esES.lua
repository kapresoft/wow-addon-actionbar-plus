...
L['Layout Type Tooltip'] = 'La cuadrícula está integrada. Los diseños adicionales (como Arco) son complementos aparte y opcionales que puedes instalar para más formas.'
L['Grid'] = 'Cuadrícula'
L['Arc'] = 'Arco'
