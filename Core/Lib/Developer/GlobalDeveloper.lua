...
kns.DEV_CONSOLE_FONT = ConsoleMonoCondensedSemiBoldOutline
local font, size, flags = kns.DEV_CONSOLE_FONT:GetFont()
...
log('font, size, flags:', font, size, flags)
